...
*/
    ...
    $response = $this->call('POST', 'uploadAssetManifest',array('manifest' => '{"Items":[{"price":"199", "description":"A silly red hat.", "uuid":"01234567890123456789", "name":"Red Hat", "version":"1.005"}, {"price":"595", "description":"none", "uuid":"1170626816", "name":"Big Red Bat", "version":"1"}, {"price":"2", "description":"none", "uuid":"1136337664", "name":"Magnums", "version":"1"}, {"price":"85", "description":"none", "uuid":"1951233", "name":"Sunny", "version":"1"}]}'));

    $this->assertTrue($this->client->getResponse()->isOk());
    $response = $this->client->getResponse()->getContent();

    //Grab the items from the database
    $redHat = SteamApi_Item::find($this->item->uuid);
    ...
    $this->assertEquals($this->item->uuid, $manifest->items[3]->uuid);
