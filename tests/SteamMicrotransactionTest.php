...
class MicrotransactionTest extends TestCase {
	...
	public function testInitTxn()
	{
		...
		$orderId = '938473'; //unique, arbitrary number generated by our system
...
//		$response = $auth->AuthenticateUserTicket($appId, $ticket);

//		$this->assertEquals('OK', json_encode($response), json_encode($response));
